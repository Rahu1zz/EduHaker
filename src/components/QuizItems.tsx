...
export const QuizItem: React.FC<QuizItems> = ({
  Quiz,
  toggleComplete,
  deleteQuiz,
  assignPerson,
    ...
    >
      <div className="flex items-center">
        <input
          ...
          onChange={() => toggleComplete(Quiz.id)}
        />
        <span
          className={`ml-2 text-sm ${
            Quiz.isCompleted ? "text-gray-500 line-through" : "text-gray-900"
          }`}
        >
          {Quiz.assignedTo && (
